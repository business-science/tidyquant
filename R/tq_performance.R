...
#' @seealso
#' \itemize{
#'   \item \code{\link{tq_transform}} which can be used to calculate period returns from a
...
#'            to   = "2015-12-31") %>%
#'     group_by(symbol) %>%
#'     tq_transform(Ad, periodReturn, period = "monthly", col_rename = "Ra")
#'
...
#'            from = "2010-01-01",
#'            to   = "2015-12-31") %>%
#'     tq_transform(Ad, periodReturn, period = "monthly", col_rename = "Rb")
#'
