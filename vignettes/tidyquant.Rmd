...
Stock lists for three stock exchanges are avaiable: NASDAQ, NYSE, and AMEX. To get a full list of the options, use `tq_exchange_options()`. Here we get the full list of stocks on the NASDAQ exchange.
...
#### Multiple Stocks with Compound Gets
