...
Minimizing the number of functions reduces the learning curve: 

* __Get a Stock Index, `tq_index()`__: Returns the stock symbol and company name for every stock in an index. Eighteen indexes are avalable.
