...
First, create a custom regression function. An important point is that the "data" will be passed to the regression function as an `xts` object. The `timekit::tk_tbl` function takes care of converting to a data frame.

```{r}
regr_fun <- function(data) {
    coef(lm(MA ~ V, data = timekit::tk_tbl(data, silent = TRUE)))
}
```
