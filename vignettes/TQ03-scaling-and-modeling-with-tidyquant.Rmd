...
Testing it out on a single stock. We can see that the "term" that contains the direction of the trend is "year(date)". The interpetation is that as year increases one unit, the annual returns decrease by 3%. 
